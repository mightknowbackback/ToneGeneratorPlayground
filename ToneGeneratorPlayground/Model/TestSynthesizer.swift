...
class TestSynthesizer {
	...
	// Singletons:
	public static let fixedTone = TestSynthesizer(signal: TestOscillator.fixedSine)
	public static let movableTone = TestSynthesizer(signal: TestOscillator.variableSine)
